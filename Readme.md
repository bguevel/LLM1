...
The following plots show training loss for LLM3 (one line per Wikipedia article) and luca-gpt1 (one epoch):

![Loss vs Epochs for LLM3 (one line per article)](loss_plot_1772601295.png)
